...
description: Mission, folder layout, Flutter desktop stack, and routing for the BrewUI contribution workspace.
tags: [workspace, brewui, setup, flutter]
timestamp: 2026-07-10T12:00:00Z
---

# BrewUI Workspace Overview

This workspace is the harness for building **BrewUI** — a cross-platform desktop UI for [Homebrew](https://brew.sh).
